...
while True:
	...
	# conqeur overlapped bounding boxes with non-maximum suppression
	...
	if (time.time() - lastSeenOccupied < 10): # hold for 10 secs
		if outVideoWriter is None:
			outVideoWriter = cv2.VideoWriter("{}.avi".format(timestampFn), cv2.VideoWriter_fourcc(*'MJPG'), 30, (560, 315))
		# print(frame)
